...
\index{Realization!operator!in optimization}
...
\index{Optimization!on realized states}
...
\index{State!pose3!optimization}
...
\index{Acceleration!effective lateral!optimization objective}
...
\index{Jerk!optimization objective}
The jerk is:
\[
j
=
...
\index{Realization!inverse formulation}
The objective is:
\[
...
\index{Frequency interpretation!realization operator as low-pass filter}
...
\index{Optimization!sparse}
\index{Optimization!hybrid}
...
\index{Vehicle space!optimization interpretation}
...
\index{Reference system!ellipsoid-aware optimization}

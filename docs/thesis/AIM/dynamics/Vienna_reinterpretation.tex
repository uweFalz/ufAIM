...
\begin{definition}[Half-wave dynamics]
\label{def:half-wave-dynamics}
Half-wave dynamics denotes interpretation of transition evolution
through normalized curvature half-wave structures.
\end{definition}
...
\begin{remark}
The half-wave interpretation is not merely geometric.
It directly affects:
\begin{itemize}
...
\item half-wave structures shape dynamic behaviour,
\item realization filtering determines operational robustness,
\item spectral smoothness influences comfort and admissibility,

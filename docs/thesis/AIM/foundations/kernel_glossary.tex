...
\chapter*{Knowledge Kernel Vocabulary: Reference}
\phantomsection
...
This file is retained as a lookup reference for terminology from the
approved Knowledge Kernel. It is deliberately not part of the linear
thesis argument: terms are introduced where an engineering problem
requires them, then formalized and used. The entries below introduce no
additional theory and do not replace the canonical Knowledge Kernel.

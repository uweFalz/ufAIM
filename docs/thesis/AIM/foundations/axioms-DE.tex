...
\(\theta(s_0)\) und einer integrierbaren Krümmungsfunktion
\(\kappa\in L^1(I)\) ist die ebene Trajektorie auf \(I\) als absolut
stetige Kurve eindeutig bestimmt.
\end{proposition}

\begin{proof}
Für \(\kappa\in L^1(I)\) existieren beide nachstehenden Integrale und
definieren absolut stetige Funktionen. Die Integration von
\cref{ax:heading-evolution} ergibt
\[

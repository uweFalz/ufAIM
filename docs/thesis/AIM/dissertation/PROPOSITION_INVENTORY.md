...
- Update 2026-09-05 (DISS-04 repair 005, `DISS-04-DECISION-001` Option A): the
  eighteen former `SCI-MATH` rows now carry `\label` anchors instead of line
  numbers, because line numbers in the edited files have shifted. Line anchors
  of other rows in those files are stale until the next inventory refresh.
...
| P024 | `docs/thesis/AIM/foundations/axioms.tex` (`\label{prop:curvature-driven-reconstruction}`) | `docs/thesis/AIM/foundations/axioms-DE.tex` (`\label{prop:curvature-driven-reconstruction}`) | SCI-MATH | proof present; regularity made explicit (L^1, absolutely continuous) — DISS-04 repair 005 | Curvature-driven reconstruction: Given an initial position \((s_0)\), an initial heading \((s_0)\), and a sufficiently regular curvature function \( |
...
| P051 | `docs/thesis/AIM/modeling/sparse.tex` (`\label{cor:sparse-reconstruction-chain}`) | `docs/thesis/AIM/modeling/sparse-DE.tex` (`\label{cor:sparse-reconstruction-chain}`) | SCI-MATH | reclassified as corollary of P024 — DISS-04 repair 005 | The planar alignment is reconstructed by successive integration of the curvature law: \[ (s) (s) (s). \] |
...
| P053 | `docs/thesis/AIM/modeling/transition_classification.tex` (`\label{prop:transition-curvature-representation}`) | `docs/thesis/AIM/modeling/transition_classification-DE.tex` (`\label{prop:transition-curvature-representation}`) | SCI-MATH | hypotheses restricted (regular C^2, arc length); proof added — DISS-04 repair 005 | Any transition curve can be represented by a curvature function \[ : [0,L] . \] |
...
| P055 | `docs/thesis/AIM/modeling/transitions.tex` (`\label{def:scaled-transition-law}`) | `docs/thesis/AIM/modeling/transitions-DE.tex` (`\label{def:scaled-transition-law}`) | REFERENCE | reclassified as definition with endpoint hypotheses — DISS-04 repair 005 | Let \kappa be a normalized transition law. Then a physical transition is given by \[ (s) = _0 + (_1-_0) \, \kappa \ |
| P056 | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization.tex` (`\label{prop:curvature-el}`) | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization-DE.tex` (`\label{prop:curvature-el}`) | SCI-MATH | proof added (weak Euler–Lagrange) — DISS-04 repair 005 | If \(^\) is a minimizer, then \[ ^(s)=0. \] |
| P057 | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization.tex` (`\label{prop:curvature-el-minimizer}`) | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization-DE.tex` (`\label{prop:curvature-el-minimizer}`) | SCI-MATH | proof added (uniqueness via Cauchy–Schwarz) — DISS-04 repair 005 | The minimizer is \[ ^(s)=\kappa_1Ls . \] |
| P058 | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization.tex` (`\label{prop:curvature-el-fourth-order}`) | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization-DE.tex` (`\label{prop:curvature-el-fourth-order}`) | SCI-MATH | H^2 clamped set defined; proof added; cubic minimizer explicit — DISS-04 repair 005 | Minimizers satisfy \[ ^(4)(s)=0. \] |
| P059 | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization.tex` (`\label{cor:coupled-substitution-phi-zero}`) | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization-DE.tex` (`\label{cor:coupled-substitution-phi-zero}`) | SCI-MATH | reclassified as substitution corollary; remaining terms named — DISS-04 repair 005 | If \((s) 0\), the coupled problem reduces to a pure curvature optimization problem. |
| P060 | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization.tex` (`\label{cor:balance-identity}`) | `docs/thesis/AIM/optimization/alignment/10_continuous_curvature_optimization-DE.tex` (`\label{cor:balance-identity}`) | SCI-MATH | reclassified as balance-identity corollary; interpretation separated — DISS-04 repair 005 | If \(a_eff(s)=0\) for all \(s\), then \[ v^2 (s)=g(s), \] and the design is perfectly balanced. |
| P061 | `docs/thesis/AIM/optimization/alignment/50_sqp_analytic_structure.tex` (`\label{cor:planar-reconstruction-integrals}`) | `docs/thesis/AIM/optimization/alignment/50_sqp_analytic_structure-DE.tex` (`\label{cor:planar-reconstruction-integrals}`) | SCI-MATH | reclassified as corollary of P024; restricted to pose2 — DISS-04 repair 005 | All state variables are obtained via arc-length integration: \[ (s) = _0 + _0^s ()\,, \] \[ (s) = _0 + _0^s (,)\,.  |
| P062 | `docs/thesis/AIM/optimization/alignment/50_sqp_analytic_structure.tex` (`\label{prop:heading-parameter-derivative}`) | `docs/thesis/AIM/optimization/alignment/50_sqp_analytic_structure-DE.tex` (`\label{prop:heading-parameter-derivative}`) | SCI-MATH | domination hypotheses and proof added — DISS-04 repair 005 | \[ \partial \theta(s) p = _0^s \partial \kappa p\,. \] |
| P063 | `docs/thesis/AIM/optimization/alignment/50_sqp_analytic_structure.tex` (`\label{prop:position-parameter-derivative}`) | `docs/thesis/AIM/optimization/alignment/50_sqp_analytic_structure-DE.tex` (`\label{prop:position-parameter-derivative}`) | SCI-MATH | hypotheses and chain-rule proof added — DISS-04 repair 005 | \[ \partial \gamma(s) p = _0^s - \\ \partial \theta p\,. \] |
| P064 | `docs/thesis/AIM/optimization/alignment/50_sqp_analytic_structure.tex` (`\label{prop:exact-jacobians-smooth-block}`) | `docs/thesis/AIM/optimization/alignment/50_sqp_analytic_structure-DE.tex` (`\label{prop:exact-jacobians-smooth-block}`) | SCI-MATH | narrowed to smooth reconstruction block — DISS-04 repair 005 | The optimization problem admits exact Jacobians without numerical approximation. |
| P065 | `docs/thesis/AIM/optimization/alignment/60_parametric_and_hybrid.tex` (`\label{prop:parametric-derivative-structure}`) | `docs/thesis/AIM/optimization/alignment/60_parametric_and_hybrid-DE.tex` (`\label{prop:parametric-derivative-structure}`) | SCI-MATH | restricted to p in T; endpoint/length derivatives and proof added — DISS-04 repair 005 | Derivatives reduce to: \[ \partial \kappa p = (_1 - _0) \partial \widehat\kappa p. \] |
...
| P067 | `docs/thesis/AIM/reality/construction_and_realization.tex` (`\label{prop:realization-fixed-point}`) | `docs/thesis/AIM/reality/construction_and_realization-DE.tex` (`\label{prop:realization-fixed-point}`) | SCI-MATH | continuity hypothesis, proof and counterexample added — DISS-04 repair 005 | Fixed point interpretation: If iterative realization converges, \[ _real= A__target(_real). \] |
...
| P072 | `docs/thesis/AIM/reality/construction_and_realization.tex` (`\label{prop:physical-design-space}`) | `docs/thesis/AIM/reality/construction_and_realization-DE.tex` (`\label{prop:physical-design-space}`) | REFERENCE | reclassified as definition — DISS-04 repair 005 | The physical design space is the image of the realization operator. |
...
| P083 | `docs/thesis/AIM/state/pose2.tex` (`\label{prop:pose2-persistent-kernel}`) | `docs/thesis/AIM/state/pose2-DE.tex` (`\label{prop:pose2-persistent-kernel}`) | CONTRACT | reclassified as CONTRACT (principle environment) — DISS-04 repair 005 | The Alignment's intrinsic curvature construction is persistent engineering information; pose2 is its planar state u |
| P084 | `docs/thesis/AIM/state/pose3_and_cant.tex` (`\label{prop:pose3-reconstruction}`) | `docs/thesis/AIM/state/pose3_and_cant-DE.tex` (`\label{prop:pose3-reconstruction}`) | CONTRACT | reclassified as CONTRACT (principle environment) — DISS-04 repair 005 | pose3 reconstruction principle: Given \((s)\), \(h(s)\), and \(u(s)\), together with a starting pose, metric realization, gauge, orientation and fr |

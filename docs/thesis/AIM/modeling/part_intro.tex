...
They also reveal why the system grew beyond the originating mathematics.
Berlinish supplies a generalized transition grammar. axtranNew consumes
functions, boundary conditions, and degrees of freedom to calculate concrete
alignment structures. transitionDB preserves reusable transition knowledge,
and TransEd makes that knowledge examinable. SPOT is then needed to carry the
identity and state of concrete engineering objects, while alignmentOS provides
the operational environment in which the calculated structure can be edited,
evaluated, and related to other work. These are dependent responses to one
engineering problem, not a flat catalogue of products.

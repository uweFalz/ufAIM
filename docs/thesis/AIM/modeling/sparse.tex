...
A sparse alignment model is an ordered finite sequence of alignment
elements together with sufficient start information and concatenation
rules to reconstruct the corresponding geometric object.
\end{definition}
...
\TODO{Extend pose definition to pose3 including height, cant, and frame conventions.}
\OPEN{Clarify the exact status of pose3: geometric state, engineering state, or BIM-related state description.}
\OPEN{Fix local versus global framing consistently.}
...
\begin{remark}
This is especially important for transition registries, reusable
families, and implementation-independent comparison of element types.
\end{remark}
...
alignment by means of an ordered sequence of semantically meaningful
elements together with reconstruction data and concatenation rules.

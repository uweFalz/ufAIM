...
\begin{proposition}
Jeder Übergangsbogen kann durch eine Krümmungsfunktion
\[
\kappa:[0,L]\to\R
\]
dargestellt werden.
\end{proposition}
Diese Darstellung ist von der ursprünglichen Kurvendefinition unabhängig und
stellt einen gemeinsamen mathematischen Rahmen bereit.

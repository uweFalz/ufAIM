...
\begin{figure}[htbp]
\centering
\input{figures/modeling/sparse_model_structure-DE}
...
\begin{figure}[htbp]
\centering
\input{figures/modeling/support_alignmentdata_sparse_spotobject-DE}
...
\begin{proposition}
Das ebene Alignment wird durch sukzessive Integration des Krümmungsgesetzes
rekonstruiert:
\[

...
\begin{principle}[pose3-Rekonstruktionsprinzip]
...
Die Auswertbarkeit ergibt sich erst nach Wahl von Metrik-, Frame-,
Transport-, Spurweiten- und Konventionsoperatoren; die Bewahrung von
Alignment-Bezug und Provenienz ist ein Vertrag über diese Operatoren, keine
mathematische Folge von \(\kappa\), \(h\) und \(u\).
